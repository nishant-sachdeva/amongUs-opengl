...
void vaporise::set_dest( Direction new_dest ){
	this->init_dest = Dest;
	this->Dest = new_dest;
	rolling_status = 0;
	ismoving =true;
...
vaporise::vaporise(int x_position, int y_position, int maze_width, int maze_height, bool is_auto)
{
